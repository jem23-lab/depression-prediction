...
If the message said “I feel fine” instead of “I feel not good at all,” the overall tone would shift toward a lighter mood and the result might become moderate or mild. The change in wording would reduce the intensity of the depressive indicators.
    ...
    },
    {
        ...
        """),
        'prediction_confidence': 0.6983588782193926,
        'prediction_label': 'severe',
        'SHAP_explanation': (
            """\
...
The assessment was based on a few everyday cues. You mentioned **“mild sleep issues and occasional fatigue”** and that it’s **“moderately hard to get a good night's rest,”** both indicating that tiredness is showing up at times. You also said you’re feeling **“slightly less happy.”** These notes point to moments of getting less energy, having trouble sleeping, and a small dip in how enjoyable things feel, which the algorithm matched with common signs of mild trouble, but not enough to signal depression.
        ...
        'COUNTERFACTUAL_explanation': (
            """\
            Your screening result shows **NOT DEPRESSION**.  
The assessment leaned on a few clues: the phrase **“mild sleep issues”** suggested some trouble sleeping, and the worry about graduate school came through as **“apprehensive about whether it will go well.”** These hints point to mild stress, but they’re balanced by statements that you remain motivated, eat well, and have strong family support.

**If the message had said** “I feel completely exhausted and can’t concentrate” **instead of** “My motivation remains strong, and my concentration and appetite are completely unaffected,” **the result could shift toward moderate depression.** The lack of motivation and concentration would have raised a higher flag of concern.
        """),
        'HYBRID_explanation': (
            """\
...
If you had written, for example, “I feel hopeless instead of I feel okay,” the presence of that stronger negative mood cue would likely shift the prediction toward depression.
    ...
    },
    {
        ...
        'SHAP_explanation': (
            """\
            Your screening result suggests that you are not experiencing depression. The assessment looked at how you describe your feelings and lifestyle. Words like **accomplishments**, **doer**, and **whirlwind** showed a strong sense of motivation and activity. These hints of drive and enjoyment in your life countered any signs of low mood or lack of interest. Meanwhile, you mentioned stable concentration, appetite, and motivation, and overall feeling content and balanced. Your brief mention of mild sleep and energy dips shows you are aware of fluctuations but they are not severe enough to tip the balance. This awareness, combined with the positive highlights, supports the conclusion that you are not in a depressive state.
        """),
        'RAG_explanation': (
            """\
...
The system looked closely at a few words in your message. The phrase **“traumatic memory”** signals that you have experienced distressing events, which raises attention for mental‑health screening. The mention of your **brother** and the **teeth** detail you shared reflects personal stressors, but these are balanced by the many positive elements you described—your enthusiasm, goal‑oriented studies, and coping skills. Because the overall tone is hopeful and you actively manage thoughts, the assessment leaned toward a non‑depressed outcome.
        ...
        'COUNTERFACTUAL_explanation': (
            """\
            You’re currently classified as **not depressed**. The system looks at the overall tone and coping themes you share.  

Key parts that pulled you toward this score are the **intrusive cognitive patterns** you mention, the **painful memory** of your brother, and being **self‑conscious about your teeth**. These phrases hint at lingering distress, but they’re balanced out by the upbeat parts of your message—talk of enthusiasm for the future, your active coping skills, and your pride in your mother.  

If the message had said something like “I feel hopeless, have no energy, and can’t concentrate” instead of “I am doing very good and feeling enthusiastic,” the result would likely lean toward showing depression.
        """),
        'HYBRID_explanation': (
            """\
