...
PARAGRAPHS = [
    ...
    },
    {
        ...
        "severity": "none",
        "text": (
            "Generally, I’m doing fine and feel okay. I'm a highly introverted physics and astronomy teacher who "
            "spends long periods reading, doing math, and conducting research without much social interaction. I "
            "don't really have a best friend, but I am very close with my family, helping my aging parents with "
            "groceries and tutoring my nephews weekly. Lately, I've been experiencing mild sleep issues and occasional"
            " fatigue, finding it moderately hard to get a good night's rest, which leaves me functioning but slightly "
            "less happy. My main stressor is applying back to graduate school; I feel a bit nervous and apprehensive "
            "about whether it will go well. Aside from this academic anxiety, my motivation remains strong, and my "
            "concentration and appetite are completely unaffected. To relax and maintain a good mood, I rely on "
            "disciplined workouts, playing video games with my brother, and making mathematical breakthroughs, feeling "
            "proud of my scientific accomplishments."
        )
    },
    {
        ...
        "severity": "none",
        "text": (
            "Overall, I am doing fine and describe myself as an even-keel, level person. I am an outgoing doer and a "
            ...
            " though I occasionally deal with everyday relationship frustrations with my girlfriend, whom I find cool "
            "but sometimes arrogant. When looking back at past arguments with an ex-girlfriend, I think I could have "
            "been more patient. Generally, I feel content, balanced, and proud of my life achievements."
        )
    },
    {
        ...
        "severity": "none",
        "text": (
            "I am currently doing pretty good overall, with minimal depressive symptoms, though I've recently "
            "experienced mild fatigue and uncharacteristic sleep issues, like taking longer to fall asleep or "
            "waking up from intense dreams. I am currently in a transitional phase, job hunting after being "
            "deceptively let go from my last producing role—a situation that still brings up unresolved anger. This "
            "job search sometimes makes me feel guilty for not being productive enough. While I have a history of "
            "depression and previously struggled with basic functioning, ongoing therapy helps me notice my behavioral "
            "patterns. I value my supportive family, and being wrapped in their warm embrace over Christmas brought "
            "me true happiness after an isolating period of living alone with my dog. My best friend views me as funny,"
            " smart, and a good listener. I'm focusing on being more confident and less passive as I look for a stable "
            "full-time position."
        )
    },
    {
        ...
        "severity": "none",
        "text": (
            "I am a twenty-three-year-old journalism student who feels pretty good and enjoys life, as things are "
            "looking up with my graduation approaching and a recent internship that makes me feel accomplished. "
            "However, I have felt a little tired lately and my sleep has been disrupted for a few days by roofing "
            "workers waking me up early, making me a bit crabby. Emotionally, I have never felt depressed, but I am "
            "dealing with a heavy stressor: my childhood best friend was recently diagnosed with paranoid schizophrenia "
            "after his military service. It is incredibly hard to witness, and I feel somewhat guilty and conflicted "
            "about how to interact with him now. While I can sometimes be shy around strangers or get lackadaisical and "
    ...
    },
    {
        ...
        "severity": "none",
        "text": (
            "I am a hardworking, intelligent person who generally feels fine and considers himself someone who "
            "perseveres and never quits. Professionally, I studied business economics and am currently working "
            "toward my dream of becoming a company CEO. While I am mostly outgoing and enjoy working out or "
            "gathering with friends, I can become shy and reserved in large groups. I am very close to my family, "
            "though I wish my brother and I had handled past conflicts without fighting, and I value a supportive "
            "mentor from my church. Lately, I have been dealing with prominent fatigue and low energy, though falling "
            "asleep remains easy. Reflecting on my past, I feel I did not fully live up to my potential in high school "
