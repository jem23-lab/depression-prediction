...
def process_message(user_id: int, text: str) -> dict:
    ...
    welcome = (
        ...
        "You will go through 8 texts in total, divided into two blocks of four.\n\n"
        "In each case:\n"
        "1. You will be shown a text sample from an individual.\n"
        "2. The AI will provide a prediction of that person's depressive state.\n"
        "3. You will choose one available question about the prediction.\n"
        "4. You will see one explanation.\n"
        "5. You will rate that explanation using four short statements.\n\n"
        "Type /begin to begin."
    )
